  ...
  posts.forEach(function (post){
    ...
    //console.log("the post"+post);
     if(storedTitle===requestedTitle){
       //match found load page
       res.render("post",{storedTitle:storedTitle,storedPost:storedPost});
        console.log("match found"+storedTitle+requestedTitle);
     }else{
